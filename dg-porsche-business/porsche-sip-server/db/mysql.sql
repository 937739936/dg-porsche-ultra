...
INSERT INTO t_config (name, value, type) VALUES ('logoLarge', '/files/config/logo_large.png', 'SystemBase');
INSERT INTO t_config (name, value, type) VALUES ('logoSmall', '/files/config/logo_small.png', 'SystemBase');
INSERT INTO t_config (name, value, type) VALUES ('name', '数链科技', 'SystemBase');
INSERT INTO t_config (name, value, type) VALUES ('recordNumber', '豫ICP备2021002766号-1', 'SystemBase');
-- 用户系统样式配置
DROP TABLE IF EXISTS `t_user_style_config`;

create table t_user_style_config (
                                     id    int unsigned auto_increment comment '主键id' primary key,
                                     user_id  int(10)  not null comment '业务唯一标识',
                                     color_primary varchar(100) null comment '主题色',
                                     sider_bg varchar(100) null comment '侧边背景色',
                                     sider_color varchar(100) null comment '侧边文字色',
                                     header_bg varchar(100) null comment '头部背景色',
                                     header_color varchar(100) null comment '头部文字色',
                                     footer_bg varchar(100) null comment '底部背景色',
                                     footer_color varchar(100) null comment '底部文字色',
                                     body_bg varchar(100) null comment '主体背景色',
                                     body_block_bg varchar(100) null comment '主体区域背景色',
                                     body_block_color varchar(100) null comment '主体区域文字色',
                                     logo_color varchar(100) null comment 'logo颜色'
);

INSERT INTO t_user_style_config (id, user_id, color_primary, sider_bg, sider_color, header_bg, header_color, footer_bg, footer_color, body_bg, body_block_bg, body_block_color)
VALUES (4, 0, '#1677ff', '#ffffff', 'rgba(0,0,0,0.88)', '#ffffff', 'rgba(0,0,0,0.88)', '#f5f5f5', 'rgba(0,0,0,0.88)', '#f3f5f6', '#fff', 'rgba(0,0,0,0.88)');
