...
import com.shdatalink.sip.server.module.user.mapper.UserAccessKeyMapper;
...
@RegisterForReflection(lambdaCapturingTypes = "com.shdatalink.sip.server.module.user.service.UserAccessKeyService",
