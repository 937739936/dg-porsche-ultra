...
public class XmlUtil {
    ...
    public static <T> String toXml(XMLBuilder<T> wrapper){
        return XmlUtil.toXml(wrapper.getData(), wrapper.encoding);
    }
    ...
    public static <T> T convert(Object object, Class<T> clazz) {
        return XmlUtil.convert(object, clazz, SipConstant.CHARSET);
    }

    @SneakyThrows
    public static <T> T convert(Object object, Class<T> clazz, String charset) {
        return XmlUtil.convert(object, clazz, Charset.forName(charset));
    }
    ...
    public static <T> T convert(Object object, Class<T> clazz, Charset charset) {
        ...
        return XmlUtil.parse(XmlUtil.toXml(object).getBytes(charset), clazz, charset);
    }
}
