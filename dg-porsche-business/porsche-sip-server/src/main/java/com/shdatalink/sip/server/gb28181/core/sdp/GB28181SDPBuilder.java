...
public class GB28181SDPBuilder {
    ...
    public static GB28181Description build(Action action, String deviceId, String channelId,
                                           ...
                                           MediaStreamModeEnum streamMode, TimeDescription timeDescription,
        ...
        if(MediaStreamModeEnum.UDP.equals(streamMode)){
            ...
            mediaDescription = SdpFactory.getInstance().createMediaDescription("video", rtpPort, 0, Protocol.TCP_RTP_AVP.getProtocol(), rtpMap.keySet().toArray(new String[0]));
        }
        ...
        if (streamMode == MediaStreamModeEnum.TCP_PASSIVE) {
            // TCP-PASSIVE
        ...
        } else if (streamMode == MediaStreamModeEnum.TCP_ACTIVE) {
            // TCP-ACTIVE
    ...
    public static class Receiver {
        @SneakyThrows
        public static GB28181Description build(Action action, String deviceId, String channelId, String netType, String rtpIp, int rtpPort, String ssrc, MediaStreamModeEnum streamMode, TimeDescription timeDescription) {
        ...
        @SneakyThrows
        public static GB28181Description play(String deviceId, String channelId, String netType, String rtpIp, int rtpPort, String ssrc, MediaStreamModeEnum streamMode) {
         ...
         */
        @SneakyThrows
        public static GB28181Description play(String deviceId, String channelId, String netType, String rtpIp, int rtpPort, String ssrc, MediaStreamModeEnum streamMode, StreamType.Attribute<?> streamType) {
        ...
        @SneakyThrows
        public static GB28181Description playback(String deviceId, String channelId, String netType, String rtpIp, int rtpPort, String ssrc, MediaStreamModeEnum streamMode, Date start, Date end) {
        ...
        @SneakyThrows
        public static GB28181Description download(String deviceId, String channelId, String netType, String rtpIp, int rtpPort, String ssrc, MediaStreamModeEnum streamMode, Date start, Date end, Integer downloadSpeed) {
            TimeField timeField = new TimeField();
            timeField.setStartTime(start.toInstant().getEpochSecond());
            timeField.setStopTime(end.toInstant().getEpochSecond());
            TimeDescription timeDescription = SdpFactory.getInstance().createTimeDescription(timeField);
    ...
    public static class Sender {
        @SneakyThrows
        public static GB28181Description build(Action action, String deviceId, String channelId, String netType, String rtpIp, int rtpPort, String ssrc, MediaStreamModeEnum streamMode, TimeDescription timeDescription, Map<String,String> rtpMap, Map<String,String> fmtpMap) {
